...
int main(int argc, char* argv[])
{
	...
	if(result != 0)
	{
		...
		else
		{
			...
			{
				cout << "Nombre de ProbesMates : " << count+1;
				...
				cout << "\n Target MAC Adress : " << resp.wsdd__ProbeMatches->ProbeMatch->wsa__EndpointReference.Address[33 - 49];

				// *** SETTING UP DEVICE OBJECTS LIST *** //
